...
// "C:\\Users\\rawan\\Desktop\\zipDiffIter1\\zipDiff_Iter1\\data.db";
// private static final String FILE_NAME = "file name: ";
// private static final String FILE_PATH = "file path: ";
// GraphDatabaseFactory dbFactory = new GraphDatabaseFactory();
// GraphDatabaseService graphDb = dbFactory.newEmbeddedDatabase(new
// File(DB_PATH));
// Index<Node> zipEntry = graphDb.index().forNodes("");
//
// private static enum RelTypes implements RelationshipType {
// Regular
// }
//
// public void createDb(ArrayList<ZipEntry> entries1, ArrayList<ZipEntry>
// entries2, ZipFile zip1, ZipFile zip2) {
// clearDb();
...
// n.setProperty(FILE_PATH, metadataAndPathComparison.GetRelativePath(zip,
// tmp));
...
// ArrayList<ZipEntry> arr1 = new
// ArrayList<ZipEntry>(ZipDiffCreation.copyToArrayList(zip1));
// ArrayList<ZipEntry> arr2 = new
// ArrayList<ZipEntry>(ZipDiffCreation.copyToArrayList(zip2));
